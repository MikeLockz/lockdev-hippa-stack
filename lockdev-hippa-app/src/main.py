...
from .utils.database import get_database_url, init_database
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.warning("Database initialization failed - application will run without database", error=str(e))
